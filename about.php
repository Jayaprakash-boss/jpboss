...
<header class="navbar navbar-inverse navbar-fixed-top" style="background-color:white">
  <div class="container">
        <a class="navbar-brand  navbar-fixed-left" href="#" style="cursor: pointer"> INFINTI SOFTWARE SOLUTION </a>
...
<nav class="navbar navbar-inverse " style="background-color:white">
 ...
 <div class="col-md-4"> 
	 <div class="line1">
	  <div class="left">
	   <span> &nbsp About us </span>
	  </div>
	  </div>
	  </div>
	  <br>
	  <br>
	 <center> <img src="img/infiniti.jpg" class="img img-rounded-circle" >
	 <h4> Infiniti Software Solutions </h4>
